# Getting help with `SpecVGs`

Thank you for using `SpecVGs`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/SpecVGs`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/SpecVGs),
...
[search issues and pull requests](https://github.com/MicTott/SpecVGs/issues)
